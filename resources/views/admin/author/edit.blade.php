...
@section('content')
    ...
    <div class="form-example-area">
        <div class="container">
            <div class="row">
                <form id="createUserFrmId" action="{{route('author.update',['id'=>$author['id']])}}" method="post">
                    @csrf
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="nk-int-st">
                                                <input required type="text" class="form-control input-sm"
                                                       name="name" value="{{$author['name']}}" placeholder="Enter Name">
                                                @error('name')
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="nk-int-st">
                                                <input  type="text" class="form-control input-sm"
                                                        name="email" value="{{$author['email']}}" placeholder="Enter E-Mail">
                                                @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="nk-int-st">
                                                <input type="text" class="form-control input-sm"
                                                       name="address" value="{{$author['address']}}"
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="nk-int-st">
                                                <textarea name="details" type="text" rows="5"
                                                          class="form-control input-sm"> {{$author['details']}} </textarea>
                                                @error('details')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
