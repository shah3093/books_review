...
@section('content')
    ...
    <div class="form-example-area">
        <div class="container">
            <div class="row">
                <form id="createUserFrmId" action="{{route('user.update',['id'=>$user['id']])}}" method="post">
                    @csrf
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="nk-int-st">
                                                <input required type="text" class="form-control input-sm"
                                                       name="email" value="{{ $user['email']}}" placeholder="Enter E-Mail">
                                                @error('email')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="nk-int-st">
                                                ...
                                                <input type="text" class="form-control input-sm" id="phone"
                                                       name="phone-full" value="{{$user['phone']}}"
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="nk-int-st">
                                                <select name="user_type" class="form-control">
                                                    @foreach(\App\Models\User::USER_TYPE as $key=>$user_type)
                                                        <option {{ $user['user_type'] == $key ? "selected" :""}}  value="{{$key}}">{{$user_type}}</option>
                                                    @endforeach
                                                </select>
                                                @error('user_type')
                                                <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                            <div class="nk-int-st">
                                                <select name="status" class="form-control">
                                                    @foreach(\App\Models\User::USER_STATUS as $key=>$status)
                                                        <option {{ $user['status'] == $key ? "selected" :""}}  value="{{$key}}">{{$status}}</option>
                                                    @endforeach
                                                </select>
                                                @error('status')
                                                <span class="text-danger">{{ $message }}</span>
                                        ...
                                        <div class="col-lg-8 col-md-7 col-sm-7 col-xs-12">
                                            <div class="nk-int-st">
                                                <textarea name="details" type="text" rows="5"
                                                          class="form-control input-sm"> {{$user['details']}} </textarea>
                                                @error('details')
                                                <span class="text-danger">{{ $message }}</span>
                                                @enderror
                                            </div>
